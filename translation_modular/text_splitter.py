...
def run_splitter_on_file(file_path, source_lang=None, target_tokens=None):
    ...
    import os
    output_file = os.path.join(os.path.dirname(file_path), "chunks_split_running_code.txt")
...
# Uncomment and set your file path to run directly
# file_path = "/home/anish/OCR_gemma_facebook/pdf/english_md/nihms-1818274_easyocr.txt"
...
if __name__ == "__main__":
    ...
    # file_path = "/home/anish/OCR_gemma_facebook/pdf/english_md/nihms-1818274_easyocr.txt"
    # run_splitter_on_file(file_path)
    print("TextSplitter module loaded. Use run_splitter_on_file() for direct file processing.")
